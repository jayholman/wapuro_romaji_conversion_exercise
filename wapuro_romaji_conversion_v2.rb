def convert_string(string)
  ...
  while current_character < broken_character_array.length
    ...
    if geminates.include?(double_character) && broken_character_array[current_character - 1] != nil && broken_character_array[current_character - 1] != " "
      converted_string += "っ"
      current_character += 1
    elsif conversion_chart.key?(double_character)
